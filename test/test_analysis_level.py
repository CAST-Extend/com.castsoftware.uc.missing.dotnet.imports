...
class Test(unittest.TestCase):
    def testRegisterPlugin(self):
        ...
        analysis.add_selection(r'samples\Spirit.Mobile.Api\Spirit.Mobile.Api.csproj')
        analysis.add_dependency(r'C:\ProgramData\CAST\CAST\Extensions\com.castsoftware.dotnet.1.4.2-funcrel')
